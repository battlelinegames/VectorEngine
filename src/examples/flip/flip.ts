import { DisplayString, renderLoop, renderLoopScaleXY } from '../../engine/index';
...
class SmileObject {
  ...
  public render(): void {
    renderLoopScaleXY(this.main_layer, this.x, this.y, this.color, this.rotation, this.scale, -this.scale);
    renderLoopScaleXY(this.lefteye_layer, this.x, this.y, this.color, this.rotation, this.scale, -this.scale);
    renderLoopScaleXY(this.righteye_layer, this.x, this.y, this.color, this.rotation, this.scale, -this.scale);
    renderLoopScaleXY(this.mouth_layer, this.x, this.y, this.color, this.rotation, this.scale, -this.scale);
  }
}
